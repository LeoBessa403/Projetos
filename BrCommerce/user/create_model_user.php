...
function insert_user($nome,$email,$cor,$nivel,$login,$senha)
{
	...
	try{
		...
		echo '<meta http-equiv="refresh" content="2, URL=brcommerce.php?pg=user/create_control_user&confirmacao=ok" />';
		die();
