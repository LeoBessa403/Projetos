 <form action="brcommerce.php?pg=user/delete_control_user" method="post" enctype="multipart/form-data">
    			<fieldset>
          ...
          <form action="brcommerce.php?pg=user/delete_control_user" method="post" name="check_form">
...
<table width="100%">
	...
	?>
		  <tr bgcolor="<?php echo $cor; ?>" class="resultados" id="rest<?php echo $cont_cor; ?>">
            ...
            <td><img src="imagens/delete.png" width="15" height="12"/><a href="javascript:if(confirm('Deseja excluir esse registro ?')) {location='brcommerce.php?pg=user/delete_control_user&usu_id=<?php echo $res['USU_ID']; ?>';}" title="Excluir Usuário" class="link_edit">Excluir</a></td>
