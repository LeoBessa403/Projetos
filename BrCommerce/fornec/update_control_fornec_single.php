...
include_once("update_model_fornec_single.php");

	$objSelect = new select_model();
	$objUpdate = new update_model_fornec();

if (isset($_REQUEST['confirmacao']) && ($_REQUEST['confirmacao'] == "ok")){
	
	cadastro_alterado("Usuário","fornec/update_control_fornec");
}
...
if (isset($_POST['executar'])){
	...
	include_once("update_view_fornec_single.php");
?>
