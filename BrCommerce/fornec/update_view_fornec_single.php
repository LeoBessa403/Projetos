	<form action="brcommerce.php" method="post" name="create_fornec" id="create_fornec" enctype="multipart/form-data">
    			<fieldset>
                <?php
               ...
               <input type="hidden" name="pg" value="fornec/update_control_fornec_single" />
				<?php
					if (isset($_REQUEST['usu_id']) && ($_REQUEST['usu_id'] == $_SESSION['sessao_id_usuario']) ){
				?>
