 <form action="brcommerce.php?pg=fornec/update_control_fornec" method="post" enctype="multipart/form-data">
    			<fieldset>
			...
			$_SESSION['sessao_nivel_usuario'] = 3;
		 	...
		 	if  ($_SESSION['sessao_nivel_usuario'] <= 2){
			  ...
			  ?>
					...
					<td><a href="brcommerce.php?pg=fornec/update_control_fornec_single&usu_id=<?php echo $res['USU_ID']; ?>" class="link_edit"><img src="imagens/editar.png" width="15" height="12"/> Editar</a></td>
