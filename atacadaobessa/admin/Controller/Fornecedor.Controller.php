...
class fornecedor{ 
    ...
    function cadastroFornecedor(){   
        ...
        if(!empty($_POST[$id])):
            ...
            if(!empty($_POST['id_entidade'])):
                    ...
                    $fornec = FornecedorModel::pesquisaUmFornecedor($_POST['id_entidade']);
                    ...
                    $end   = EnderecoModel::atualizaEndereco($endereco, $fornec['id_endereco']);
        ...
        $res = array();
        if($id_ent):
            $res = FornecedorModel::pesquisaUmFornecedor($id_ent);
        endif;
       ...
       $formulario = new Form($id, "index.php?url=admin/fornecedor/cadastroFornecedor");
    ...
    function listarFornecedor(){
        ...
        $this->result = FornecedorModel::pesquisaFornecedor();
    }
}