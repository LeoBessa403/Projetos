...
class FornecedorModel{    
    ...
    public static function pesquisaFornecedor(){
        ...
        $pesquisa->Pesquisar($tabela,"where ent.tipo_entidade = 'F'",null,$campos);
        return $pesquisa->getResult();
    }
    
    public static function pesquisaFornecedorSelect(){
        $tabela = EntidadeModel::tabela." ent"
                . " inner join ".PessoaModel::tabela." pes"
                . " on pes.".EntidadeModel::chave_primaria." = ent.".EntidadeModel::chave_primaria;
    ...
    public static function pesquisaUmFornecedor($id){
       $tabela = EntidadeModel::tabela." ent"
                . " inner join ".PessoaModel::tabela." pes"
                . " on pes.".EntidadeModel::chave_primaria." = ent.".EntidadeModel::chave_primaria
                . " inner join ".DadosModel::tabela." dad"
    ...
    public static function deletaFornecedor($id){
        $tabela = EntidadeModel::tabela." ent"
                . " inner join ".PessoaModel::tabela." pes"
                . " on pes.".EntidadeModel::chave_primaria." = ent.".EntidadeModel::chave_primaria
                . " inner join ".DadosModel::tabela." dad"
